...
export default {
    ...
    created(){
        ...
        // console.log(this.orderArr[0].order[0].ordered_products[0].ordered_product.quantity);
        // ordered_products[0].product[0].size
        this.orderArr[0].order.forEach(order => {
            console.log(order.ordered_products[0].ordered_product.quantity);
        });
